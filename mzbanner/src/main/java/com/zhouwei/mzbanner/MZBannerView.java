...
public class MZBannerView<T> extends RelativeLayout {
    ...
    private final Runnable mLoopRunnable = new Runnable() {
        @Override
        public void run() {
            if (mIsAutoPlay && mDatas != null && mDatas.size() > 1) {
        ...
        for (int i = 0; i < mDatas.size(); i++) {
            ...
            if (mIndicatorAlign == IndicatorAlign.LEFT.ordinal()) {
                if (i == 0) {
                    ...
                    imageView.setPadding(paddingLeft + indexPadding, 0, indexPadding, 0);
                } else {
                    imageView.setPadding(indexPadding, 0, indexPadding, 0);
                }
                ...
                if (i == mDatas.size() - 1) {
                    ...
                    imageView.setPadding(indexPadding, 0, indexPadding + paddingRight, 0);
                } else {
                    imageView.setPadding(indexPadding, 0, indexPadding, 0);
                }
...
//        }
        ...
        if (datas.size() <= 1){
//            mAdapter.setCountFactor(1);
            if (rl_parent!=null)
                rl_parent.setClipChildren(true);
        }else {
//            mAdapter.setCountFactor(500);
            if (rl_parent!=null)
    ...
    public static class MZPagerAdapter<T> extends PagerAdapter {
        ...
        private int mLooperCountFactor = 500;
        ...
        public void setCountFactor(int count){
            this.mLooperCountFactor = count;
        }
...
//                mIsAutoPlay = false;
            ...
            view.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    if (mPageClickListener != null) {
                        mPageClickListener.onPageClick(v, mDatas.get(realPosition));
                    }
                }
            });
    ...
    public interface BannerPageClickListener {
        void onPageClick(View view, Object object);
    }
