...
public class FotaCombinedBarChart extends AppCombinedChart {
    private int type;//1 spot or kline 2 future (2 types) 3 usdt
    ...
    public FotaCombinedBarChart(Context context) {
        this(context, null);
    }

    public FotaCombinedBarChart(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public FotaCombinedBarChart(Context context, AttributeSet attrs, int defStyle) {
...
//        canvas.clipPath(filledPath);
        Drawable drawable2 = ContextCompat.getDrawable(getContext(), R.drawable.spot_dark);//blue
        Drawable drawable1 = ContextCompat.getDrawable(getContext(), R.drawable.future_dark);//green

        //jiang 位移 volume
        if(type == 2 || type == 3) {
//            drawable1.setBounds((int) mViewPortHandler.contentLeft() + (int) Utils.convertDpToPixel(1.0f),
//                    (int) mViewPortHandler.contentTop(),
//                    (int) mViewPortHandler.contentRight() - (int) Utils.convertDpToPixel(1.5f),
//                    (int) mViewPortHandler.contentBottom());

//            drawable1.setBounds((int) mViewPortHandler.contentLeft(),
//                    (int) mViewPortHandler.contentTop(),
...
//            drawable1.draw(canvas);
        ...
        if(type == 1 || type == 2) {
//            drawable2.setBounds((int) mViewPortHandler.contentLeft(),
//                    (int) mViewPortHandler.contentTop(),
//                    (int) mViewPortHandler.contentRight(),
//                    (int) mViewPortHandler.contentBottom());
