...
//                trans.pathValueToPixelNoOffset(filled);
//                Path addPath = new Path();
//                float[] mBuffer = new float[2];
//                mBuffer[0] = 0;
//                mBuffer[1] = 0;
//                final Entry entry = dataSet.getEntryForIndex(0);
//                final float fillMin = dataSet.getFillFormatter().getFillLinePosition(dataSet, mChart);
//                mBuffer[0] = entry.getX();
//                mBuffer[1] = fillMin;
//                trans.pointValuesToPixelNoOffset(mBuffer);
//                addPath.lineTo(mBuffer[0], mBuffer[1] + Utils.convertDpToPixel(50));
//                Entry entry1 = dataSet.getEntryForIndex(currentEndIndex);
//                mBuffer[0] = entry1.getX();
//                trans.pointValuesToPixelNoOffset(mBuffer);
//                addPath.moveTo(mBuffer[0], mBuffer[1] + Utils.convertDpToPixel(50));
//                filled.addPath(addPath);
