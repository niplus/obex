 ...
 */
public class FotaBigTimeLineBarChartView extends BaseChartView implements FotaCoupleChartGestureListener.OnAxisChangeListener {
    ...
    public void setChartType(ChartType chartType) {
        ...
        mChartVolume.setType(chartType.ordinal() + 1);
        setLegendLoading(false, chartType.ordinal() + 1);
    }
    ...
    public FotaBigTimeLineBarChartView(Context context) {
        this(context, null);
    }

    public FotaBigTimeLineBarChartView(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public FotaBigTimeLineBarChartView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    protected void initBottomChart(FotaCombinedBarChart chart) {
...
//        barDataSet.setColors(getResources().getColor(R.color.increasing_color), getResources().getColor(R.color.decreasing_color));
    ...
    private LineDataSet setLine(int type, ArrayList<Entry> lineEntries) {
        ...
        if (type == TRADE_LINE) {
            ...
            Drawable drawable;
            if(chartType == ChartType.SPOT) {
                lineDataSet.setLabel("spot");
                ...
                drawable = ContextCompat.getDrawable(mContext, R.drawable.fade_spot_dark);
            } else {
