...
public class DatePickerView extends View {
    ...
    public void setSelected(String mSelectItem) {
        for (int i = 0; i < mDataList.size(); i++) {
            String str = StringFormatUtils.delYDM(mDataList.get(i));
            if (str.equals(mSelectItem)) {
                setSelected(i);
                break;
            }
        }
    ...
    private void init() {
        ...
        //被选中的数字颜色
        mPaint.setColor(Pub.getColor(getContext(), R.attr.font_color));
        //第二个paint
        nPaint = new Paint(Paint.ANTI_ALIAS_FLAG);
        nPaint.setStyle(Style.FILL);
        nPaint.setTextAlign(Align.CENTER);
        //未选中的数字颜色
        nPaint.setColor(Pub.getColor(getContext(), R.attr.font_color2));
    }
