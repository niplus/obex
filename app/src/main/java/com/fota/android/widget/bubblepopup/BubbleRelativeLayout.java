    ...
    private void init(final Context context, final AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            try {
                ...
                SHADOW_COLOR = Pub.getColor(context, R.attr.font_color4);
                ...
                STROKE_WIDTH = a.getFloat(R.styleable.bubble_customStrokeWidth, STROKE_WIDTH);
                CORNER_RADIUS = a.getFloat(R.styleable.bubble_customCornerRadius, CORNER_RADIUS);
            } finally {
                if (a != null) {
                    a.recycle();
                }
        ...
        mFillPaint.setColor(Pub.getColor(context, R.attr.bg_color));
        mFillPaint.setShader(new LinearGradient(100f, 0f, 100f, 200f, Pub.getColor(context, R.attr.reverse_bg2), Pub.getColor(context, R.attr.reverse_bg2), Shader.TileMode.CLAMP));

        if (Build.VERSION.SDK_INT >= 11) {
            setLayerType(LAYER_TYPE_SOFTWARE, mFillPaint);
        }
        mPaint.setShadowLayer(2f, 1F, 1F, SHADOW_COLOR);
