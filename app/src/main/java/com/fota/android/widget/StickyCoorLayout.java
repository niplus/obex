...
/**
 * Created by jiang on 2018/11/28.
 */

public class StickyCoorLayout extends LinearLayout implements NestedScrollingParent {

    private static final String TAG = "StickyCoorLayout";
    ...
    public StickyCoorLayout(Context context, AttributeSet attrs)
    {
        super(context, attrs);
