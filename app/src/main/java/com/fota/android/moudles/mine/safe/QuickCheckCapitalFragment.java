...
import com.fota.android.databinding.FragmentQuickcapitalBinding;
 ...
 * 手势指纹认证资金密码
 */
public class QuickCheckCapitalFragment extends BaseFragment implements View.OnClickListener {
    FragmentQuickcapitalBinding mBinding;
    ...
    protected View onCreateFragmentView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mBinding = DataBindingUtil.inflate(inflater, R.layout.fragment_quickcapital, container, false);
    ...
    private void initStatus(int status) {
        if (1 == status) {
            mBinding.tvCapitalpsw1.setVisibility(View.VISIBLE);
            ...
            mBinding.tvCapitalpsw1.setVisibility(View.GONE);
            mBinding.lock.setVisibility(View.VISIBLE);
            mBinding.imvFinger.setVisibility(View.GONE);
    ...
    protected void onInitView(View view) {
        ...
        mBinding.tvCapitalpsw1.setOnClickListener(this);
        mBinding.tvCapitalpsw2.setOnClickListener(this);
                ...
                public void onGestureFinished(@NonNull int[] numbers) {
                    if (numbers.length >= 4) {
                        ...
                        if (gesture.equals(savedGesture)) {
                            Event event = Event.create(R.id.event_capital_quickcheck_suc);
                            event.putParam(String.class, page);
                            EventWrapper.post(event);
//                            showToast(mContext.getResources().getString(R.string.safe_gesture_check_suc));
                            finish();
                        } else {
                            gestureerrorTimes++;
                            if (gestureerrorTimes < 5) {
                                ...
                                showToast(mContext.getResources().getString(R.string.safe_gesture_check_error5times));
                                DialogUtils.showDialog(getContext(), new DialogModel()
                                        ...
                                        .setSureClickListen(new DialogInterface.OnClickListener() {
                                            ...
                                            public void onClick(DialogInterface dialogInterface, int i) {
                                                ...
                                                Event event2 = Event.create(R.id.event_capital_quickcheck_fail);
                                                event2.putParam(String.class, page);
                                                EventWrapper.post(event2);
                                                finish();
                                            }
                                        })
                                );
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.tv_capitalpsw1:
            case R.id.tv_capitalpsw2:
                Event event2 = Event.create(R.id.event_capital_quickcheck_fail);
                event2.putParam(String.class, page);
                EventWrapper.post(event2);
                finish();
    ...
    private void identity() {
        mFingerprintIdentify.startIdentify(MAX_AVAILABLE_TIMES, new BaseFingerprint.IdentifyListener() {
            ...
            public void onSucceed() {
                ...
                event.putParam(String.class, page);
                EventWrapper.post(event);
//                showToast(mContext.getResources().getString(R.string.safe_finger_check_suc));
                finish();
            }
