package com.fota.android.service;
...
import com.fota.android.utils.downloadutils.UriUtil;
 ...
 * Created by sunchao
 * 版本下载更新
 * https://www.jianshu.com/p/32afaa19fe56
 */
...
//                L.a("currentLength  = " + currentLength + "  +progress = " + progress + " oldProgress = " + oldProgress + "  length = " + length);
...
//        builder.setTicker("开始下载");
        ...
        mRemoteViews.setTextViewText(R.id.notification_download_title, FotaApplication.getInstance().getResources().getString(R.string.update_download_title));
        ...
        mNotification.icon = R.mipmap.icon_logo;
    ...
    private void updateNotification(Message msg) {
        ...
        mRemoteViews.setTextViewText(R.id.notification_note_tv, FotaApplication.getInstance().getResources().getString(R.string.update_downloading_notification) + aFloat + "%");
        mNotificationManager.notify(0, mNotification);
    }

    // 下载完成后打开安装apk界面
    public void installApk(Message msg) {
        Event event = Event.create(R.id.update_downloaded);
        EventWrapper.post(event);//通知隐藏下载提示框
        File file = (File) msg.obj;
        if (file == null || file.length() == 0) {
            mRemoteViews.setTextViewText(R.id.notification_note_tv, FotaApplication.getInstance().getResources().getString(R.string.update_download_fail));
            //下载失败,flags设置为可关闭
        ...
        mRemoteViews.setTextViewText(R.id.notification_note_tv, FotaApplication.getInstance().getResources().getString(R.string.update_downloaded));
        //下载完成,flags设置为可关闭
