...
// http://shouji.360tpcdn.com/180920/3740af2a32503749e8154108e7b9924e/com.aulton.aee_18.apk
public class AppDownloadManager {
    ...
    public void downloadApk(String apkUrl, String title, String desc) {
        ...
        File apkFile = new File(weakReference.get().getExternalFilesDir(Environment.DIRECTORY_DOWNLOADS), "fota.apk");
        ...
        request.setDestinationInExternalFilesDir(weakReference.get(), Environment.DIRECTORY_DOWNLOADS, "fota.apk");
        ...
        if (completeDownLoadId == mReqId) {
            if (Build.VERSION.SDK_INT < Build.VERSION_CODES.M) { // 6.0以下
                ...
                uri = FileProvider.getUriForFile(context,
                        FotaApplication.getInstance().getPackageName() + ".updateProvider",
                        new File(context.getExternalFilesDir(Environment.DIRECTORY_DOWNLOADS), "fota.apk"));
